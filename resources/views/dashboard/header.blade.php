    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item pb-3 move-up-li"><a class="navbar-brand" href="{{ url('/superAdmin/dashboard') }}"><img class="brand-logo" style="width: 40px" alt="stack admin logo" src="{{ url('shops/' .  $userShop->logo) }}">
            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="avatar avatar-online"><img src="{{ url('shops/' .  $userShop->logo) }}" alt="avatar"><i></i></div><span class="user-name">{{ auth()->user()->name }}</span>
                        </a>
